...
export class AdministrationService {
  ...
  getreverseBoolean(value) {
    ...
    completed_innovation_status = new BehaviorSubject(false);
    completed_is_innovator = new BehaviorSubject(false);
    ...
    set_innovation_status(status){
      this.completed_innovation_status.next(status);
    }
    get_innovation_status(){
      return this.completed_innovation_status.value;
    }

    set_is_innovator(status){
      this.completed_is_innovator.next(status);
    }
    get_is_innovator(){
      return this.completed_is_innovator.value;
    }
