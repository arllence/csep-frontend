...
@NgModule({
  declarations: [CommonErrorComponent, CommonLoaderComponent,
    CommonFooterComponent, CommonHeaderComponent,CommonProfileViewComponent, GenericProfileViewComponent, CommonProfileComponent,CommonEmailComponent, SafePipe, FilterPipe],
  imports: [
    AppAsideModule,
    AppBreadcrumbModule,
    AppHeaderModule,
