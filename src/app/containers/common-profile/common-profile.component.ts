...
import { serverurl,get_complete_profile,create_profile_url,check_completed_profile, upload_document_url, innovation_skills_url, employment_status_url } from '../../app.constants';
